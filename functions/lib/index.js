...
async function handleCampaigns(req, res) {
    if (req.method === 'GET') {
        ...
        const newCampaign = Object.assign(Object.assign({ id: Date.now().toString() }, campaignData), { status: 'active', created_at: new Date().toISOString(), updated_at: new Date().toISOString() });
